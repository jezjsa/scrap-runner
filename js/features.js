export const FEATURES = [
  ...
  },
  {
    title: "UI",
    items: [
      "Sky, midground, and the rusted frame stack as you exported them. The midground has a clear back so the sky shows through the towers. Sky and midground drift as you move. You, the bots, the cells, and the vault door draw in front of the scrap",
